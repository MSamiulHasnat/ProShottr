...
## Corpus Check
- 70 files · ~38,184 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 1161 nodes · 1629 edges · 70 communities (59 shown, 11 thin omitted)
...
Cohesion: 0.12
Nodes (15): dart:isolate, dart:math, package:version/version.dart, AndroidEnvironment, buildEnvironment, clangLinkerWrapper, installNdk, _libGccWorkaround (+7 more)
...
Cohesion: 0.09
Nodes (21): IconButton, package:flutter/gestures.dart, package:proshottr/features/editor/editor_screen.dart, package:proshottr/services/capture_service.dart, package:proshottr/services/windows_capture_window.dart, capabilities, captureCount, captureDesktop (+13 more)
...
Cohesion: 0.09
Nodes (25): cargo.dart, crate_hash.dart, options.dart, package:ed25519_edwards/ed25519_edwards.dart, package:http/http.dart, precompile_binaries.dart, rustup.dart, AritifactType (+17 more)
...
Cohesion: 0.08
Nodes (24): FlutterViewController, LONG_PTR, MethodChannel, FlutterWindow, capture_window_channel_, editor_extended_style_, editor_placement_, editor_style_ (+16 more)
...
Cohesion: 0.15
Nodes (17): artifacts_provider.dart, builder.dart, environment.dart, package:path/path.dart, target.dart, build, BuildCMake, userOptions (+9 more)
...
Cohesion: 0.11
Nodes (18): package:flutter/services.dart, static const, bottom, CaptureWindowController, _channel, left, prepareCapture, restoreEditor (+10 more)
...
Cohesion: 0.26
Nodes (17): LONG, DartProject, EncodableValue, ExitApplication, FlutterWindow::FlutterWindow(), HideEditorWindow, InstallTrayIcon, OnCreate (+9 more)

### Community 27 - "Win32 Window Base (C++)"
Cohesion: 0.19
Nodes (13): Size, wchar_t, Scale(), Create, Destroy, UpdateTheme, Win32Window::Win32Window(), WindowClassRegistrar (+5 more)
...
Cohesion: 0.15
Nodes (12): RECT, HWND, Win32Window, child_content_, GetClientArea, OnCreate, OnDestroy, quit_on_close_ (+4 more)
...
Cohesion: 0.18
Nodes (10): dart:io, package:toml/toml.dart, CrateInfo, fileName, load, ManifestException, message, packageName (+2 more)
...
Cohesion: 0.20
Nodes (9): package:logging/logging.dart, enableVerboseLogging, initLogging, kDoubleSeparator, kSeparator, _lastMessageWasSeparator, _log, out (+1 more)
...
Cohesion: 0.23
Nodes (12): State, StatefulWidget, CaptureSelectionOverlay, _CaptureSelectionOverlayState, QuickCaptureView, _QuickCaptureViewState, _StickerPickerDialog, _StickerPickerDialogState (+4 more)
...
### Community 43 - "Win32 Message Types"
Cohesion: 0.33
...
Cohesion: 0.12
Nodes (15): int?, static final, all, android, androidMinSdkVersion, androidTargets, buildableTargets, darwinArch (+7 more)

### Community 52 - "Selection Overlay Widget"
Cohesion: 0.13
Nodes (14): dart:convert, dart:typed_data, Digest, File, package:collection/collection.dart, package:convert/convert.dart, package:crypto/crypto.dart, compute (+6 more)
...
## Knowledge Gaps
- **637 isolated node(s):** `build`, `_DragMode`, `frame`, `controller`, `windowController` (+632 more)
